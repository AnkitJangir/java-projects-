...
/**
 * Servlet implementation class serviceaa
 */
public class serviceaa extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select * from service where sto=? and sfrom=? and stype=?");
			ps.setString(1,toa);
			ps.setString(2,froma);
